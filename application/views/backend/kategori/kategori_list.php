                ...
                <tbody><?php
                        ...
                        <tr>
                            ...
                            <td style="text-align:center" width="200px">
                                <?php
                                echo anchor(site_url('kategori/read/' . $kategori->id_kat), 'Read', 'class="btn btn-xs btn-success"');
                                echo ' | ';
                                echo anchor(site_url('kategori/update/' . $kategori->id_kat), 'Update', 'class="btn btn-xs btn-warning"');
                                echo ' | ';
                                echo anchor(site_url('kategori/delete/' . $kategori->id_kat), 'Delete', 'class="btn btn-xs btn-danger" onclick="javascript: return confirm(\'Yakin hapus data?\')"');
                                ?>
                            </td>
                        </tr>
